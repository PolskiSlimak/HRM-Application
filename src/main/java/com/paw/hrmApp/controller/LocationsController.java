...
public class LocationsController {
    ...
    private LocationDTO getSpecificLocations(@ApiParam(value = "Id of location", example = "1") @PathVariable Long id) {
        LocationDTO locationDTO = new LocationDTO();
    ...
    private void deleteLocation(@ApiParam(value = "Id of location", example = "1") @PathVariable Long id) {
